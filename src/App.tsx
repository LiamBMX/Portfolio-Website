...
function App() {
  ...
  const projects = [
    ...
    {
      title: 'RedGen',
      description: 'Subscription-based service that generates faceless portrait videos for TikTok using AI.',
    ...
    },
    {
      ...
      description: 'AI-powered horror storytelling YouTube channel (script to voiceover automation).',
